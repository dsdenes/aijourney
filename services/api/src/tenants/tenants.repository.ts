...
export class TenantsRepository {
  ...
  async incrementUsage(tenantId: string, field: string, amount: number): Promise<void> {
   ...
   */
  async updateRaw(tenantId: string, setFields: Record<string, unknown>): Promise<void> {
    await this.col.updateOne(
      { _id: tenantId },
