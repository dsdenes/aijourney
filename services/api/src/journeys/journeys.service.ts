import type { CreateJourneyInput, Journey, UpdateJourneyInput } from '@aijourney/shared';
...
export class JourneysService {
  ...
  async create(input: CreateJourneyInput, runRequestId?: string): Promise<Journey> {
    const now = nowISO();
