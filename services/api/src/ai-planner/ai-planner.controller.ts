...
export class AiPlannerController {
  ...
  @Post('questions')
  @ApiOperation({
    summary: 'Generate 6 specification questions for a given round',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @Post('strategy')
  @ApiOperation({
    summary: 'Generate final AI usage strategy from goal + all answers',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  async generateStrategy(
    ...
    try {
      ...
      if (body.userId) {
        ...
        this.memoryService
          .enqueueExtraction(body.userId, 'ai-planner', memoryInput)
          .catch(() => {});
      }
