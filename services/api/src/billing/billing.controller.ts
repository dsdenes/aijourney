...
export class BillingController {
  ...
  async createPortal(@TenantId() tenantId: string, @Body() body: { returnUrl: string }) {
    const result = await this.billingService.createPortalSession(tenantId, body.returnUrl);
    return { data: result };
  }
