...
const { runRagIngestion, ensureCollection, chunkDocuments, embedTexts } =
	await import("./rag-ingestor.js");
...
describe("RAG Ingestor", () => {
	...
	describe("embedTexts", () => {
		it("should embed texts via OpenAI text-embedding-3-small", async () => {
