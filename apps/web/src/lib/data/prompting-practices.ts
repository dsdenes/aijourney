...
export const promptingPractices: PromptingPractice[] = [
	{
		...
		summary:
			"Tell the AI exactly what you need — the more detail, the better the answer.",
	...
	},
	{
		...
		summary:
			'Start with "You are a..." to tell the AI what kind of expert it should act as.',
		...
		examples: [
			{
				...
				whyBetter:
					"You get a clean, ready-to-use comparison table instead of a long paragraph.",
			},
			{
	...
	},
	{
		...
		examples: [
			...
			},
			{
				...
				whyBetter:
					"Each step gets full attention, and you can steer the AI's direction as you go.",
			},
		],
	},
	{
		...
		summary:
			'Show the AI a sample of the style or format you like — "make it like this."',
	...
	},
	{
		...
		summary:
			"Mention things you want to avoid — jargon, certain topics, a specific tone, etc.",
	...
	},
	{
		...
		summary:
			'Add "think step by step" or "reason through this" to get more thoughtful answers.',
		...
		examples: [
			...
			},
			{
				...
				whyBetter:
					"The AI analyzes each possible factor instead of guessing one generic answer.",
			},
		],
	},
	{
	...
	},
	{
		...
		summary:
			'Say "give me 3 versions" or "suggest 5 alternatives" so you can pick the best one.',
	...
	},
	{
		...
		summary:
			"Ask for ideas, alternatives, or creative angles — then pick the best ones yourself.",
	...
	},
	{
		...
		summary:
			'After getting an answer, say "Now review this for errors" or "What did you miss?"',
	...
	},
	{
		...
		summary:
			"Tell the AI which parts are urgent, most important, or have deadlines.",
	...
	},
	{
		...
		summary:
			"When you're stuck, ask the AI what you might be missing or should consider.",
	...
	},
	{
		...
		summary:
			"Ask the AI to do one thing at a time rather than five things in one message.",
	...
	},
	{
		...
		summary:
			"If you need the response in a specific language, say so explicitly.",
