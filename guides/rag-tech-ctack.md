...
This guide is _only_ about choosing the RAG stack (components + products + where they live), not about prompt design or chunking details.
...
## 1) Top-level decision: _Where does retrieval live?_
...
This is about _how you wire ingestion → retrieval → rerank → answer_, not where vectors live.
