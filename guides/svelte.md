...
SvelteKit is *full-stack*; state choices must account for SSR + hydration. Use this hierarchy:
...
Use stores when multiple components need the same client-side state *and* it is not server state.
